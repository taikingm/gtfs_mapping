...
def gtfs_mapping(city_name):
    ...
    routes = pd.read_csv(f"data/{city_name}_gtfs/routes.txt")
    shapes = pd.read_csv(f"data/{city_name}_gtfs/shapes.txt")
    stops = pd.read_csv(f"data/{city_name}_gtfs/stops.txt")
    trips = pd.read_csv(f"data/{city_name}_gtfs/trips.txt")
